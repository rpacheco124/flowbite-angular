        ...
        <flowbite-demo-page>
            ...
            <flowbite-demo-example
                ...
                <div class="flex flex-row gap-1">
                    ...
                    <flowbite-button (click)="modalExtraLarge.open()">Extra large</flowbite-button>
                </div>
            ...
            [codes]="[examples[2]]">
                <flowbite-button (click)="dismissModal.open()">Open modal</flowbite-button>
                <flowbite-modal #dismissModal [dismissable]="true">
                    ...
                    <flowbite-modal-footer>
                        <flowbite-button (click)="dismissModal.close()">I accept</flowbite-button>
                        <flowbite-button (click)="dismissModal.close()" [color]="'gray'">I decline</flowbite-button>
                    </flowbite-modal-footer>
                </flowbite-modal>
            </flowbite-demo-example>
            <flowbite-demo-example 
