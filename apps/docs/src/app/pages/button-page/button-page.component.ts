...
@Component({
  standalone: true,
  imports: [ButtonComponent, BadgeComponent, DemoPageComponent, DemoExampleComponent],
  ...
  template: `<flowbite-demo-page>
    ...
    <flowbite-demo-example title="Button pills" [codes]="[examples[1]]">
      <div class="flex flex-wrap gap-2">
    ...
    <flowbite-demo-example title="Gradient monochrome" [codes]="[examples[2]]">
      <div class="flex flex-wrap gap-2">
    ...
    <flowbite-demo-example title="Gradient duo-tone" [codes]="[examples[3]]">
      <div class="flex flex-wrap gap-2">
    ...
    <flowbite-demo-example title="Gradient outline" [codes]="[examples[4]]">
      <div class="flex flex-wrap gap-2">
    ...
    <flowbite-demo-example title="Outline buttons" [codes]="[examples[5]]">
      <div class="flex flex-wrap gap-2">
        <flowbite-button [outline]="true"> Default </flowbite-button>
        <flowbite-button [outline]="true" color="dark"> Dark </flowbite-button>
        <flowbite-button [outline]="true" color="success">
          Success
        </flowbite-button>
        <flowbite-button [outline]="true" color="failure">
          Failure
        </flowbite-button>
        <flowbite-button [outline]="true" color="warning">
          Warning
        </flowbite-button>
        <flowbite-button [outline]="true" color="purple">
          Purple
        </flowbite-button>
      </div>
    </flowbite-demo-example>
    <flowbite-demo-example title="Button sizes" [codes]="[examples[6]]">
    ...
    <flowbite-demo-example title="Buttons with icon" [codes]="[examples[7]]">
      <div class="flex flex-wrap items-center gap-2">
        <flowbite-button>
          <svg
